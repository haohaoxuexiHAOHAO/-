...
<div class="main">
    ...
    <form action="<%=request.getContextPath()%>/Register/aaa" method="post" onsubmit="return check(this)">
        <div class="form-group">
            ...
            <input type="radio" name="IdCard" value="teacher">老师
            <input type="radio" name="IdCard" value="student">学生
